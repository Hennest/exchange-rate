...
interface ExchangeRateInterface
{
     ...
     *
     * @param string $currency The currency code for which the exchange rate is requested.
     *
     * @return float The exchange rate as a floating-point number.
     *
     * @throws RequestException If the request to the API fails.
     *
     ...
     *
     * @return float The converted amount as a floating-point number.
     *
     * @throws RequestException If the request to the API fails.
     *
     * @throws InvalidCurrencyException If an invalid currency code is provided.
